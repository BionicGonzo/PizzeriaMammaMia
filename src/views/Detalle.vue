      ...
      <div class="row g-0">
        ...
        <div class="col-md-7">
          <div class="card-body">
            ...
            <ul>
              <li class="text-capitalize w-75" v-for="(ingrediente, i) in pizza.ingredients" :key="i">
                &#127829; {{ingrediente}}
              </li>
            </ul>
...
export default {
  ...
  computed: {
    ...
    pizza(){
      const {id} = this; // de la constante id se va a pasar como argumento al getter pizzaById, dando como resultado que dentro del componente Detalle, en la computed property se verá la información de la pizza seleccionada
